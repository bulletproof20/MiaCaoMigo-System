...
'Reorder candidates from vw_produtos_para_encomendar (at or below minimum stock).';
...
'Application wrapper for sp_check_restock_needs (notices when vw_produtos_para_encomendar is non-empty).';
