...
alter table employee drop constraint if exists fk_employee_aut_reg;
alter table employee
...
alter table employee drop constraint if exists fk_employee_aut_ina;
alter table employee
...
alter table assistant drop constraint if exists fk_assistant_employee;
...
alter table veterinarian drop constraint if exists fk_veterinarian_employee;
...
alter table expert drop constraint if exists fk_expert_veterinarian;
alter table expert
...
alter table expert drop constraint if exists fk_expert_specialty;
alter table expert
...
alter table client drop constraint if exists fk_client_user;
alter table client
...
alter table login_record drop constraint if exists fk_login_record_user;
...
alter table setup drop constraint if exists fk_setup_user;
alter table setup
...
alter table schedule drop constraint if exists fk_schedule_employee;
...
alter table absence drop constraint if exists fk_absence_employee;
alter table absence
...
alter table absence drop constraint if exists fk_absence_responsible;
alter table absence
...
alter table clock_in drop constraint if exists fk_clock_employee;
...
alter table occupies drop constraint if exists fk_occ_employee;
...
alter table occupies drop constraint if exists fk_occ_profile;
alter table occupies
...
alter table have drop constraint if exists fk_have_profile;
alter table have
...
alter table have drop constraint if exists fk_have_permission;
alter table have
