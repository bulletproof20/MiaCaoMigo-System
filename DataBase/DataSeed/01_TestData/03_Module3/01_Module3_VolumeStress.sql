-- =========================================================
-- TEST DATA — MODULE 3 — VOLUME STRESS (isolated)
-- =========================================================
--
-- TIER: 01_TestData (fixtures only — NOT in 03_TestData.sql default chain)
-- Run on empty commercial schema or dedicated QA database only.
--
-- =========================================================
-- 1. USER_ACCOUNT (80 base users: 40 employee + 40 client slots)
-- =========================================================
WITH names AS (
    SELECT
